...
<div id="welcome-panel" class="about-wrap">
	...
	<p class="about-text"> Xenon is a free photography WordPress theme. This is a WordPress 3+ ready theme with features like custom background, custom menu, featured images, widgetized sidebar etc. Theme also comes with an option panel.The highlight feature of the theme is that you can customize the color scheme and link colors via the theme customizer option. </p>
