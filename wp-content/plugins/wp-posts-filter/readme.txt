...
With WP Posts Filter you can filter posts by category or tag to list them in the particular page.
...
The rest of placeholders available represent data fetched from WP database by the plugin:
